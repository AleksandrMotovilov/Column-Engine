...
OUT_PATH = os.path.join(OUT_DIR, f"queries_s_{DATASET}_{BATCH_ROWS_NUMBER}.png")
...
ax.set_title(f"Column-Engine — время выполнения запросов на датасете {DATASET}.csv с размером батча {BATCH_ROWS_NUMBER}, с")
ax.legend()
